...
public class EarthquakeActivity extends AppCompatActivity {
     ...
     *
     * AsyncTask has three generic parameters: input type, a type used for progress updates and an
     * output type. The task here will take a String url, and return an Earthquake.
     */
    private class EarthquakeAsyncTask extends AsyncTask<String, Void, List<Earthquake>> {

        /**
         * This method runs on a background thread and performs the network request
         * No updating of the UI from a background thread, so we return a list of {@link Earthquake}s
         * as the result.
         */
        @Override
